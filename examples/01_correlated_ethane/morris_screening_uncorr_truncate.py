...
#
# Start with screening in physical parameter space.
...
for T in temperatures:
    conditions.append({
        'name': f'uncorr_truncate_{T}K',        # name for the directory where analysis will be run
        'temperature': T,       # K
...
results = ezuq.morris_screen.save_reduced_set(working_dir, conditions, i_sens, mu_star_threshold=mu_star_threshold, verbose=False, truncate_in_decomposed_space=False)
